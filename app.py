...
# #         if x is not None and x.strip():  # Check if x is not None and not empty
# #             try:
# #                 int_feature.append(int(x))  # Try to convert to int
# #             except ValueError:
# #                 return render_template('error.html', error_message="Invalid input: all form values must be integers")
# #         else:
# #             return render_template('error.html', error_message="Invalid input: all form values are required")
